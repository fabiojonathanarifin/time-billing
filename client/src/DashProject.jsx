function DashProject() {
  return (
    <div className="flex flex-col items-center mb-6 pb-6 pt-6 sm:justify-center bg-gray-100">
      <div className="w-full flex flex-col items-center px-6 py-4 mt-6 overflow-hidden bg-white shadow-md sm:max-w-lg sm:rounded-xl">
        <svg
        ...
        <table className="border-separate [border-spacing:0.75rem] mt-6 mb-2 text-gray-600">
